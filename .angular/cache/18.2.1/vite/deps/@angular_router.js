import { Title } from './chunk-MX76GCVH.js'
...
;(function (EventType2) {
    ...
    EventType2[(EventType2['RouteConfigLoadStart'] = 9)] =
...
var OutletContext = class {
    get injector() {
        return (
            getClosestRouteInjector(this.route?.snapshot) ?? this.rootInjector
        )
    }
...
_ChildrenOutletContexts.ɵfac = function ChildrenOutletContexts_Factory(
    __ngFactoryType__,
) {
...
function getInherited(route, parent, paramsInheritanceStrategy = 'emptyOnly') {
    ...
    if (
        parent !== null &&
        (paramsInheritanceStrategy === 'always' || // inherit parent data if route is empty path
            routeConfig?.path === '' || // inherit parent data if parent was componentless
            (!parent.component && !parent.routeConfig?.loadComponent))
    ) {
        inherited = {
            params: __spreadValues(
                __spreadValues({}, parent.params),
                route.params,
            ),
...
function advanceActivatedRoute(route) {
    if (route.snapshot) {
        ...
        if (
            !shallowEqual(currentSnapshot.queryParams, nextSnapshot.queryParams)
        ) {
...
_RoutedComponentInputBinder.ɵfac = function RoutedComponentInputBinder_Factory(
    __ngFactoryType__,
) {
...
function createNode(routeReuseStrategy, curr, prevState) {
    if (
        ...
        const children = createOrReuseChildren(
            routeReuseStrategy,
            curr,
            prevState,
        )
        ...
        if (future === curr) {
            ...
            if (future.component) {
                ...
                if (this.routeReuseStrategy.shouldAttach(future.snapshot)) {
                    const stored = this.routeReuseStrategy.retrieve(
                        future.snapshot,
                    )
...
function checkGuards(injector, forwardEvent) {
    return mergeMap((t) => {
        ...
        if (
            canDeactivateChecks.length === 0 &&
            canActivateChecks.length === 0
        ) {
            return of(
    ...
    const canActivateChildGuardsMapped = canActivateChildGuards.map((d) => {
        return defer(() => {
            const guardsMapped = d.guards.map((canActivateChild) => {
                const closestInjector =
                    getClosestRouteInjector(d.node) ?? injector
                const guard = getTokenOrFunctionIdentity(
                    canActivateChild,
                    closestInjector,
                )
...
function matchWithChecks(
    ...
    return runCanMatchGuards(injector, route, segments, urlSerializer).pipe(
        map((v) => (v === true ? result : __spreadValues({}, noMatch))),
    )
}
                ...
                return this.getChildConfig(injector, route, segments).pipe(
                    switchMap(({ routes: childConfig }) => {
                        ...
                        const snapshot = new ActivatedRouteSnapshot(
                            ...
                            parameters,
                            Object.freeze(
                                __spreadValues({}, this.urlTree.queryParams),
                            ),
                            this.urlTree.fragment,
                            getData(route),
                            getOutlet(route),
...
_DefaultTitleStrategy.ɵfac = function DefaultTitleStrategy_Factory(
    __ngFactoryType__,
) {
...
_ɵEmptyOutletComponent.ɵfac = function ɵEmptyOutletComponent_Factory(
    __ngFactoryType__,
) {
...
_RouterConfigLoader.ɵfac = function RouterConfigLoader_Factory(
    __ngFactoryType__,
) {
...
_UrlHandlingStrategy.ɵfac = function UrlHandlingStrategy_Factory(
    __ngFactoryType__,
) {
                    ...
                    args: [
                        {
                            providedIn: 'root',
                            useFactory: () =>
                                inject(DefaultUrlHandlingStrategy),
                        },
                    ],
                },
            ],
...
_DefaultUrlHandlingStrategy.ɵfac = function DefaultUrlHandlingStrategy_Factory(
    __ngFactoryType__,
) {
...
var _NavigationTransitions = class _NavigationTransitions {
    ...
    handleNavigationRequest(request) {
        ...
        this.transitions?.next(
            __spreadProps(
                __spreadValues(
                    __spreadValues({}, this.transitions.value),
                    request,
                ),
                {
                    id,
                ...
                return of(overallTransitionState).pipe(
                        ...
                        if (
                            ...
                            return of(t).pipe(
                                ...
                                tap((t2) => {
                                    ...
                                    this.currentNavigation = __spreadProps(
                                        __spreadValues(
                                            {},
                                            this.currentNavigation,
                                        ),
                            ...
                            this.currentTransition = overallTransitionState =
                                __spreadProps(__spreadValues({}, t), {
                                    ...
                                    extras: __spreadProps(
                                        __spreadValues({}, extras),
                                        {
                    ...
                    catchError((e) => {
                        ...
                        if (isNavigationCancelingError(e)) {
                            ...
                            try {
                                const navigationErrorHandlerResult =
                                    runInInjectionContext(
                                        this.environmentInjector,
                                        () =>
                                ...
                                if (
                                    navigationErrorHandlerResult instanceof
                                    RedirectCommand
                                ) {
...
_NavigationTransitions.ɵfac = function NavigationTransitions_Factory(
    __ngFactoryType__,
) {
...
_RouteReuseStrategy.ɵfac = function RouteReuseStrategy_Factory(
    __ngFactoryType__,
) {
        ...
        if (e instanceof NavigationStart) {
            ...
            if (this.urlUpdateStrategy === 'eager') {
                if (!currentTransition.extras.skipLocationChange) {
                    ...
                    this.setBrowserUrl(
                        currentTransition.targetBrowserUrl ?? rawUrl,
                        currentTransition,
                    )
                }
            }
    ...
    setBrowserUrl(url, transition) {
        ...
        if (
            ...
            const state = __spreadValues(
                __spreadValues({}, transition.extras.state),
...
function afterNextNavigation(router, action) {
    router.events
        .pipe(
            ...
            filter((result) => result !== NavigationResult.REDIRECTING),
            take(1),
        )
        .subscribe(() => {
            action()
...
var _Router = class _Router {
            ...
            (e) => {
                try {
                    ...
                    if (
                        ...
                        this.stateManager.handleRouterEvent(
                            e,
                            currentNavigation,
                        )
                        if (
                            ...
                            const extras = __spreadValues(
                                {
                                    browserUrl:
                                        currentTransition.extras.browserUrl,
                                    info: currentTransition.extras.info,
                                    skipLocationChange:
                                        currentTransition.extras
                                            .skipLocationChange,
    ...
    createUrlTree(commands, navigationExtras = {}) {
        ...
        switch (
            queryParamsHandling ??
            this.options.defaultQueryParamsHandling
        ) {
            case 'merge':
                q = __spreadValues(
...
_PreloadAllModules.ɵfac = function PreloadAllModules_Factory(
    __ngFactoryType__,
) {
    ...
    preloadConfig(injector, route) {
        return this.preloadingStrategy.preload(route, () => {
            ...
            if (route.loadComponent && !route._loadedComponent) {
                ...
                return from([recursiveLoadChildren$, loadComponent$]).pipe(
                    mergeAll(),
                )
            } else {
...
_RouterModule.ɵfac = function RouterModule_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _RouterModule)(
        ɵɵinject(ROUTER_FORROOT_GUARD, 8),
    )
}
