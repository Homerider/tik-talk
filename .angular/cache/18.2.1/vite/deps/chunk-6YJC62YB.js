...
_PlatformNavigation.ɵfac = function PlatformNavigation_Factory(
    __ngFactoryType__,
) {
...
_BrowserPlatformLocation.ɵfac = function BrowserPlatformLocation_Factory(
    __ngFactoryType__,
) {
...
_PathLocationStrategy.ɵfac = function PathLocationStrategy_Factory(
    __ngFactoryType__,
) {
...
_HashLocationStrategy.ɵfac = function HashLocationStrategy_Factory(
    __ngFactoryType__,
) {
...
function getDateTranslation(date, locale, name, width, form, extended) {
    switch (name) {
        ...
        case TranslationType.Eras:
            return getLocaleEraNames(locale, width)[
...
function getFirstThursdayOfYear(year) {
    ...
    return createDate(
        ...
        0,
        1 +
            (firstDayOfYear <= THURSDAY ? THURSDAY : THURSDAY + 7) -
            firstDayOfYear,
    )
}
...
function formatNumberToLocaleString(
    ...
    if (!isFinite(value)) {
        ...
        if (digits.length >= pattern.lgSize) {
            groups.unshift(
                digits.splice(-pattern.lgSize, digits.length).join(''),
            )
        }
        while (digits.length > pattern.gSize) {
            groups.unshift(
                digits.splice(-pattern.gSize, digits.length).join(''),
            )
        }
        if (digits.length) {
    ...
    const positiveParts =
            positive.indexOf(DECIMAL_SEP) !== -1
                ...
                : [
                      positive.substring(
                          0,
                          positive.lastIndexOf(ZERO_CHAR) + 1,
                      ),
                    ...
                    args: [
                        {
                            providedIn: 'root',
                            useFactory: (locale) =>
                                new NgLocaleLocalization(locale),
                            deps: [LOCALE_ID],
                        },
                    ],
                },
...
_NgLocaleLocalization.ɵfac = function NgLocaleLocalization_Factory(
    __ngFactoryType__,
) {
            ...
            if (this.ngComponentOutlet) {
                ...
                if (this._needToReCreateNgModuleInstance(changes)) {
                    ...
                    if (this.ngComponentOutletNgModule) {
                        ...
                        this._moduleRef =
                            this.ngComponentOutletNgModuleFactory.create(
                                getParentInjector(injector),
                            )
                    } else {
...
_NgComponentOutlet.ɵfac = function NgComponentOutlet_Factory(
    __ngFactoryType__,
) {
...
var _NgSwitchDefault = class _NgSwitchDefault {
    constructor(viewContainer, templateRef, ngSwitch) {
        if ((typeof ngDevMode === 'undefined' || ngDevMode) && !ngSwitch) {
            throwNgSwitchProviderNotFoundError(
                'ngSwitchDefault',
                'NgSwitchDefault',
            )
        }
...
var _NgTemplateOutlet = class _NgTemplateOutlet {
    ...
    _shouldRecreateView(changes) {
        return (
            ...
            !!changes['ngTemplateOutletInjector']
        )
    }
    /**
...
_PreconnectLinkChecker.ɵfac = function PreconnectLinkChecker_Factory(
    __ngFactoryType__,
) {
...
_PreloadLinkCreator.ɵfac = function PreloadLinkCreator_Factory(
    __ngFactoryType__,
) {
...
var _NgOptimizedImage = class _NgOptimizedImage {
    constructor() {
        ...
        this.lcpObserver = ngDevMode
            ? this.injector.get(LCPImageObserver)
            : null
    ...
    hostBindings: function NgOptimizedImage_HostBindings(rf, ctx) {
        if (rf & 2) {
            ɵɵstyleProp('position', ctx.fill ? 'absolute' : null)(
                'width',
                ctx.fill ? '100%' : null,
            )('height', ctx.fill ? '100%' : null)(
                'inset',
                ctx.fill ? '0' : null,
            )('background-size', ctx.placeholder ? 'cover' : null)(
                'background-position',
                ctx.placeholder ? '50% 50%' : null,
            )('background-repeat', ctx.placeholder ? 'no-repeat' : null)(
                'background-image',
                ctx.placeholder
                    ? ctx.generatePlaceholder(ctx.placeholder)
                    : null,
            )(
                'filter',
                ctx.placeholder &&
                    ctx.shouldBlurPlaceholder(ctx.placeholderConfig)
                    ? 'blur(15px)'
                    : null,
            )
        }
                    ...
                    args: [
                        {
                            ...
                            host: {
                                ...
                                '[style.background-size]':
                                    'placeholder ? "cover" : null',
                                '[style.background-position]':
                                    'placeholder ? "50% 50%" : null',
                                '[style.background-repeat]':
                                    'placeholder ? "no-repeat" : null',
...
function assertUnderDensityCap(dir, value) {
    const underDensityCap = value
        ...
        .every(
            (num) =>
                num === '' || parseFloat(num) <= ABSOLUTE_SRCSET_DENSITY_CAP,
        )
    if (!underDensityCap) {
        throw new RuntimeError(
            2952,
...
This issue can occur if "width" and "height" attributes are added to an image without updating the corresponding image styling. To fix this, adjust image styling. In most cases, adding "height: auto" or "width: auto" to the image styling will fix this issue.`,
            ...
            const recommendedWidth =
                RECOMMENDED_SRCSET_DENSITY_CAP * renderedWidth
            const recommendedHeight =
                RECOMMENDED_SRCSET_DENSITY_CAP * renderedHeight
...
@angular/common/fesm2022/common.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-6YJC62YB.js.map
