import { withHttpTransferCache } from './chunk-KSLRD6RZ.js'
import {
    CommonModule,
    DOCUMENT,
    DomAdapter,
...
_DomRendererFactory2.ɵfac = function DomRendererFactory2_Factory(
    __ngFactoryType__,
) {
...
var DefaultDomRenderer2 = class {
    ...
    insertBefore(parent, newChild, refChild) {
        if (parent) {
            const targetParent = isTemplateNode(parent)
                ? parent.content
                : parent
...
_EventDelegationPlugin.ɵfac = function EventDelegationPlugin_Factory(
    __ngFactoryType__,
) {
...
_HammerGestureConfig.ɵfac = function HammerGestureConfig_Factory(
    __ngFactoryType__,
) {
...
var _HammerGesturesPlugin = class _HammerGesturesPlugin extends EventManagerPlugin {
    ...
    addEventListener(element, eventName, handler) {
        ...
        if (!window.Hammer && this.loader) {
            this._loaderPromise =
                this._loaderPromise ||
                zone.runOutsideAngular(() => this.loader())
                ...
                this._loaderPromise
                    .then(() => {
                        ...
                        if (!cancelRegistration) {
                            deregister = this.addEventListener(
                                element,
                                eventName,
                                handler,
                            )
...
_HammerGesturesPlugin.ɵfac = function HammerGesturesPlugin_Factory(
    __ngFactoryType__,
) {
...
@angular/platform-browser/fesm2022/platform-browser.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-MX76GCVH.js.map
