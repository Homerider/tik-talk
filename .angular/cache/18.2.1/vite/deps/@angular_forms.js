...
_NgControlStatus.ɵdir = ɵɵdefineDirective({
	...
	hostBindings: function NgControlStatus_HostBindings(rf, ctx) {
		if (rf & 2) {
			ɵɵclassProp('ng-untouched', ctx.isUntouched)('ng-touched', ctx.isTouched)(
				'ng-pristine',
				ctx.isPristine
			)('ng-dirty', ctx.isDirty)('ng-valid', ctx.isValid)(
				'ng-invalid',
				ctx.isInvalid
			)('ng-pending', ctx.isPending)
		}
	},
	features: [ɵɵInheritDefinitionFeature]
})
	...
	hostBindings: function NgControlStatusGroup_HostBindings(rf, ctx) {
		if (rf & 2) {
			ɵɵclassProp('ng-untouched', ctx.isUntouched)('ng-touched', ctx.isTouched)(
				...
				'ng-invalid',
				ctx.isInvalid
			)('ng-pending', ctx.isPending)('ng-submitted', ctx.isSubmitted)
		}
	},
	features: [ɵɵInheritDefinitionFeature]
})
...
_SelectControlValueAccessor.ɵdir = ɵɵdefineDirective({
	...
	hostBindings: function SelectControlValueAccessor_HostBindings(rf, ctx) {
		if (rf & 1) {
			ɵɵlistener(
				'change',
				function SelectControlValueAccessor_change_HostBindingHandler($event) {
					return ctx.onChange($event.target.value)
				}
...
_SelectMultipleControlValueAccessor.ɵfac = /* @__PURE__ */ (() => {
	...
	return function SelectMultipleControlValueAccessor_Factory(
		...
		return (
			...
			(ɵSelectMultipleControlValueAccessor_BaseFactory = ɵɵgetInheritedFactory(
...
_PatternValidator.ɵfac = /* @__PURE__ */ (() => {
	...
	return function PatternValidator_Factory(__ngFactoryType__) {
		return (
			...
			(ɵPatternValidator_BaseFactory = ɵɵgetInheritedFactory(_PatternValidator))
