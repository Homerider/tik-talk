...
import { __async, __objRest, __spreadValues } from './chunk-WDMUDEB6.js'
    ...
    applyUpdate(update) {
        ...
        switch (update.op) {
            ...
            case 's':
                ...
                const base =
                    (update.op === 'a' ? this.headers.get(key) : void 0) || []
                base.push(...value)
                ...
                switch (update.op) {
                    ...
                    case 'd':
                        if (update.value !== void 0) {
                            ...
                            const idx = base2.indexOf(
                                valueToString(update.value),
                            )
                            if (idx !== -1) {
                                base2.splice(idx, 1)
                            }
...
;(function (HttpEventType2) {
    ...
    HttpEventType2[(HttpEventType2['DownloadProgress'] = 3)] =
        'DownloadProgress'
...
;(function (HttpStatusCode2) {
    ...
    HttpStatusCode2[(HttpStatusCode2['PartialContent'] = 206)] =
        'PartialContent'
    ...
    HttpStatusCode2[(HttpStatusCode2['RequestTimeout'] = 408)] =
        'RequestTimeout'
    HttpStatusCode2[(HttpStatusCode2['Conflict'] = 409)] = 'Conflict'
    HttpStatusCode2[(HttpStatusCode2['Gone'] = 410)] = 'Gone'
    HttpStatusCode2[(HttpStatusCode2['LengthRequired'] = 411)] =
        'LengthRequired'
    ...
    HttpStatusCode2[(HttpStatusCode2['InternalServerError'] = 500)] =
        'InternalServerError'
    HttpStatusCode2[(HttpStatusCode2['NotImplemented'] = 501)] =
        'NotImplemented'
    HttpStatusCode2[(HttpStatusCode2['BadGateway'] = 502)] = 'BadGateway'
    HttpStatusCode2[(HttpStatusCode2['ServiceUnavailable'] = 503)] =
        'ServiceUnavailable'
    HttpStatusCode2[(HttpStatusCode2['GatewayTimeout'] = 504)] =
        'GatewayTimeout'
...
_HttpInterceptorHandler.ɵfac = function HttpInterceptorHandler_Factory(
    __ngFactoryType__,
) {
...
_JsonpClientBackend.ɵfac = function JsonpClientBackend_Factory(
    __ngFactoryType__,
) {
        ...
        return source.pipe(
            switchMap(() => {
                return new Observable((observer) => {
                    ...
                    const onLoad = () => {
                        let { headers, status, statusText, url } =
                            partialFromXhr()
                        let body = null
...
_HttpXsrfCookieExtractor.ɵfac = function HttpXsrfCookieExtractor_Factory(
    __ngFactoryType__,
) {
...
_HttpXsrfInterceptor.ɵfac = function HttpXsrfInterceptor_Factory(
    __ngFactoryType__,
) {
...
_HttpClientXsrfModule.ɵfac = function HttpClientXsrfModule_Factory(
    __ngFactoryType__,
) {
...
_HttpClientJsonpModule.ɵfac = function HttpClientJsonpModule_Factory(
    __ngFactoryType__,
) {
...
function transferCacheInterceptorFn(req, next) {
    ...
    if (
        ...
        (requestMethod === 'POST' &&
            ...
            !requestOptions) ||
        (requestMethod !== 'POST' &&
            !ALLOWED_METHODS.includes(requestMethod)) || // Do not cache request that require authorization when includeRequestsWithAuthHeaders is falsey
...
@angular/common/fesm2022/http.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-KSLRD6RZ.js.map
